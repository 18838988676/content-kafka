package cn.com.hbase.config;


import cn.com.hbase.config.hbasetemp.HBaseOperations;
...
public class HBaseTemplateTest {
    ...
    public void testCreateTable() {
        System.out.println(hBaseDao);
        hBaseDao.createTable("test123", "CF1", "CF2");
    }
    ...
    public void testTableExist() {
        System.out.println(hBaseDao.tableExists("stu"));
